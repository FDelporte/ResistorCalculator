...
public class CalculateLedResistorTest {
    ...
    public void testCalculation1() {
        assertEquals(55, CalculateLedResistor.from(3.3, 2.2, 0.02));
    }

    @Test
    public void testCalculation2() {
        assertEquals(140, CalculateLedResistor.from(5, 2.2, 0.02));
    }

    @Test
    public void testCalculation3() {
        assertEquals(17, CalculateLedResistor.from(9, 2.9, 0.35));
    }
}
